...
#  define LV_MEM_CUSTOM_ALLOC(size)   COS_Malloc((UINT32)size, 0x00)       /*Wrapper to malloc*/
#  define LV_MEM_CUSTOM_FREE    COS_Free         /*Wrapper to free*/
#  define LV_MEM_CUSTOM_REALLOC   COS_Realloc
#endif     /*LV_MEM_CUSTOM*/
...
#define LV_SHADOW_CACHE_SIZE    (128*4)
