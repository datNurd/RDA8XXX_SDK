...
#ifdef TGT_WITH_MCD_IF_null
// =============================================================================
// MCD config for NULL interface
// -----------------------------------------------------------------------------
/// Configuration for NULL MCD interface (no memory card support)
/// Empty configuration structure since null interface has no parameters
// =============================================================================
#ifndef TGT_MCD_CONFIG
#define TGT_MCD_CONFIG                                                  \
    {                                                                   \
...
#endif //TGT_WITH_FM_MODEL_rdafm_8809
