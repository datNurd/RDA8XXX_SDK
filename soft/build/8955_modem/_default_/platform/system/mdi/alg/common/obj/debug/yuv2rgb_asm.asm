...
# 1 "<command-line>" 2
# 1 "src/yuv2rgb_asm.S"
#void VidRec_yuv2rgb(char* srcbuf,int src_w,int src_h,char* desbuf,int padding);
#function: convert yuv422 image to RGB565 format,for LCD display
